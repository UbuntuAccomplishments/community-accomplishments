[accomplishment]
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-pundit_title")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-pundit_description")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-pundit_summary")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-pundit_steps")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-pundit_tips")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-pundit_pitfalls")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-pundit_links")
// ACCOMPLISHMENT: Pundit on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-pundit_help")
