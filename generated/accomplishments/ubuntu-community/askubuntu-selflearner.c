[accomplishment]
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-selflearner_title")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-selflearner_description")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-selflearner_summary")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-selflearner_steps")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-selflearner_links")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-selflearner_tips")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-selflearner_pitfalls")
// ACCOMPLISHMENT: Self-Learner on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-selflearner_help")
