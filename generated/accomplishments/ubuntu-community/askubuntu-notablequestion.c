[accomplishment]
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Notable Question on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-notablequestion_title")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-notablequestion_description")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-notablequestion_summary")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-notablequestion_steps")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-notablequestion_tips")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-notablequestion_pitfalls")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-notablequestion_links")
// ACCOMPLISHMENT: Notable Question on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-notablequestion_help")
