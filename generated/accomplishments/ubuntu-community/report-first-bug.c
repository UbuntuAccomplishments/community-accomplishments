[accomplishment]
// ACCOMPLISHMENT: Report First Bug ('t' field)
// .
...
_("ubuntu-community/report-first-bug_title")
// ACCOMPLISHMENT: Report First Bug ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/report-first-bug_description")
// ACCOMPLISHMENT: Report First Bug ('s' field)
// .
// ORIGINAL TRANSLATION:
...
// There are a few different ways in which you can file a bug, but we recommend you use a tool called <tt>ubuntu-bug</tt> that comes pre-installed on all Ubuntu systems. This tool helps gather up necessary information that can be useful for the developer to find the source of the bug so they can resolve it.
...
_("ubuntu-community/report-first-bug_summary")
// ACCOMPLISHMENT: Report First Bug ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/report-first-bug_steps")
// ACCOMPLISHMENT: Report First Bug ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/report-first-bug_tips")
// ACCOMPLISHMENT: Report First Bug ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/report-first-bug_pitfalls")
// ACCOMPLISHMENT: Report First Bug ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/report-first-bug_links")
// ACCOMPLISHMENT: Report First Bug ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/report-first-bug_help")
