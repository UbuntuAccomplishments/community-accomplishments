[accomplishment]
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-tageditor_title")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
// First Tag Wiki Edit
...
_("ubuntu-community/askubuntu-tageditor_description")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-tageditor_summary")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tageditor_steps")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tageditor_tips")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tageditor_pitfalls")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-tageditor_links")
// ACCOMPLISHMENT: Tag Editor on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tageditor_help")
