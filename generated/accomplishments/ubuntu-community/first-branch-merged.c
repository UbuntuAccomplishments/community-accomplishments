[accomplishment]
// ACCOMPLISHMENT: First Bazaar Branch Merged ('t' field)
// .
...
_("ubuntu-community/first-branch-merged_title")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/first-branch-merged_description")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/first-branch-merged_summary")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/first-branch-merged_steps")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/first-branch-merged_tips")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/first-branch-merged_pitfalls")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/first-branch-merged_links")
// ACCOMPLISHMENT: First Bazaar Branch Merged ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/first-branch-merged_help")
