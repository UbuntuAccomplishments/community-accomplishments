[accomplishment]
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Suffrage on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-suffrage_title")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-suffrage_description")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-suffrage_summary")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// You first need to earn the privilege to vote up (15 reputation) on Ask Ubuntu if you have not already.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-suffrage_steps")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-suffrage_tips")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-suffrage_pitfalls")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-suffrage_links")
// ACCOMPLISHMENT: Suffrage on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-suffrage_help")
