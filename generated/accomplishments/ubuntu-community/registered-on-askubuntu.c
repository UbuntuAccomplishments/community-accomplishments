[accomplishment]
// ACCOMPLISHMENT: Register on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/registered-on-askubuntu_title")
// ACCOMPLISHMENT: Register on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/registered-on-askubuntu_description")
// ACCOMPLISHMENT: Register on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/registered-on-askubuntu_summary")
// ACCOMPLISHMENT: Register on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/registered-on-askubuntu_steps")
// ACCOMPLISHMENT: Register on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/registered-on-askubuntu_links")
// ACCOMPLISHMENT: Register on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/registered-on-askubuntu_help")
