[accomplishment]
// ACCOMPLISHMENT: Student on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Student on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-student_title")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-student_description")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-student_summary")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// Log into Ask Ubuntu and ask a new question by clicking the "Ask question" link near the top-right side of the page.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-student_steps")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-student_tips")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-student_pitfalls")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-student_links")
// ACCOMPLISHMENT: Student on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-student_help")
