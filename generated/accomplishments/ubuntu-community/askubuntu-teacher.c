[accomplishment]
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Teacher on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-teacher_title")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-teacher_description")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-teacher_summary")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// Log into Ask Ubuntu and look for a question you know the answer to.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-teacher_steps")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-teacher_tips")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-teacher_pitfalls")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-teacher_links")
// ACCOMPLISHMENT: Teacher on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-teacher_help")
