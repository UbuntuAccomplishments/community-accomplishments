[accomplishment]
// ACCOMPLISHMENT: Imported an SSH Key ('t' field)
// .
...
_("ubuntu-community/imported-ssh-key_title")
// ACCOMPLISHMENT: Imported an SSH Key ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/imported-ssh-key_description")
// ACCOMPLISHMENT: Imported an SSH Key ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/imported-ssh-key_summary")
// ACCOMPLISHMENT: Imported an SSH Key ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/imported-ssh-key_steps")
// ACCOMPLISHMENT: Imported an SSH Key ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/imported-ssh-key_links")
// ACCOMPLISHMENT: Imported an SSH Key ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/imported-ssh-key_help")
