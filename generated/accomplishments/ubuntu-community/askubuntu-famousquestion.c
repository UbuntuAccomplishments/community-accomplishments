[accomplishment]
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-famousquestion_title")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-famousquestion_description")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-famousquestion_summary")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// Create a <a href="http://meta.askubuntu.com/questions/257/how-does-ask-ubuntu-work">good question</a>.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-famousquestion_steps")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-famousquestion_tips")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-famousquestion_pitfalls")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-famousquestion_links")
// ACCOMPLISHMENT: Famous Question on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-famousquestion_help")
