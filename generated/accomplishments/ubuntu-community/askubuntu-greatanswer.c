[accomplishment]
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Great Answer on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-greatanswer_title")
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-greatanswer_description")
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// Answer score of 100 or more. These answers represent the very best content from Ask Ubuntu contributors. They typically take many revisions and additions to receive 100 votes from your peers.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-greatanswer_steps")
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-greatanswer_tips")
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-greatanswer_pitfalls")
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-greatanswer_links")
// ACCOMPLISHMENT: Great Answer on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-greatanswer_help")
