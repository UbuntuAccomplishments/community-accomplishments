[accomplishment]
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct ('t' field)
// .
...
_("ubuntu-community/signed-code-of-conduct_title")
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/signed-code-of-conduct_description")
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct ('s' field)
// .
// ORIGINAL TRANSLATION:
...
// It includes expectations around being considerate, respectful, collaborative, how to ask for help, and how to step down when you become too busy.
...
_("ubuntu-community/signed-code-of-conduct_summary")
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct ('s' field)
// .
// ORIGINAL TRANSLATION:
...
// Visit the <a href="https://launchpad.net/codeofconduct">Code Of Conduct page</a>.
// Download the Ubuntu Code of Conduct, using the link located in the second step of the page, and open it.
// Sign it by opening a terminal and running <tt>gpg --clearsign UbuntuCodeofConduct-*.txt</tt>.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/signed-code-of-conduct_steps")
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/signed-code-of-conduct_links")
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/signed-code-of-conduct_help")
