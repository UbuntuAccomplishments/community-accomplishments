[accomplishment]
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-goodquestion_title")
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-goodquestion_description")
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-goodquestion_summary")
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-goodquestion_steps")
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-goodquestion_tips")
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-goodquestion_links")
// ACCOMPLISHMENT: Good Question on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-goodquestion_help")
