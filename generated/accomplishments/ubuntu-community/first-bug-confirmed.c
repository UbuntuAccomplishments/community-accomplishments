[accomplishment]
// ACCOMPLISHMENT: Filed Bug that was Confirmed ('t' field)
// .
...
_("ubuntu-community/first-bug-confirmed_title")
// ACCOMPLISHMENT: Filed Bug that was Confirmed ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/first-bug-confirmed_description")
// ACCOMPLISHMENT: Filed Bug that was Confirmed ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/first-bug-confirmed_summary")
// ACCOMPLISHMENT: Filed Bug that was Confirmed ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/first-bug-confirmed_steps")
// ACCOMPLISHMENT: Filed Bug that was Confirmed ('l' field)
// .
// ORIGINAL TRANSLATION:
// http://www.ubuntu.com
...
_("ubuntu-community/first-bug-confirmed_links")
// ACCOMPLISHMENT: Filed Bug that was Confirmed ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/first-bug-confirmed_help")
