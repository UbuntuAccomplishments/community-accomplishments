[accomplishment]
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Proofreader on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-proofreader_title")
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-proofreader_description")
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-proofreader_summary")
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-proofreader_pitfalls")
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-proofreader_links")
// ACCOMPLISHMENT: Proofreader on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-proofreader_help")
