[accomplishment]
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-tenacious_title")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-tenacious_description")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-tenacious_summary")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tenacious_steps")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tenacious_tips")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tenacious_pitfalls")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-tenacious_links")
// ACCOMPLISHMENT: Tenacious on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-tenacious_help")
