[accomplishment]
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Peer Pressure on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-peerpressure_title")
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-peerpressure_description")
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-peerpressure_summary")
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// Post a question or answer (an unintentionally bad one).
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-peerpressure_steps")
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-peerpressure_pitfalls")
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-peerpressure_links")
// ACCOMPLISHMENT: Peer Pressure on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-peerpressure_help")
