[accomplishment]
// ACCOMPLISHMENT: Signed the Canonical Contributors Agreement ('t' field)
// .
...
_("ubuntu-community/canonical-contributor_title")
// ACCOMPLISHMENT: Signed the Canonical Contributors Agreement ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/canonical-contributor_description")
// ACCOMPLISHMENT: Signed the Canonical Contributors Agreement ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/canonical-contributor_summary")
// ACCOMPLISHMENT: Signed the Canonical Contributors Agreement ('s' field)
// .
// ORIGINAL TRANSLATION:
...
// Click on the <tt>I agree</tt> button.
// You will now be added to a queue to be approved. Congratulations! Please wait a few days to see your membership in Launchpad.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/canonical-contributor_steps")
// ACCOMPLISHMENT: Signed the Canonical Contributors Agreement ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/canonical-contributor_links")
// ACCOMPLISHMENT: Signed the Canonical Contributors Agreement ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/canonical-contributor_help")
