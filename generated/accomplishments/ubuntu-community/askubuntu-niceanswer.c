[accomplishment]
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Nice Answer on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-niceanswer_title")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-niceanswer_description")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// These posts show how good answers should look like. They typically take a few revisions and additions to receive a score of 10 from the community (where <i>score</i> is the difference between up- and down-votes).
...
_("ubuntu-community/askubuntu-niceanswer_summary")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
// Answer a question, you can start with some <a href="http://askubuntu.com/unanswered">unanswered ones</a>.
// Receive enough up-votes to get a score of 10 from the site's users.
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-niceanswer_steps")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-niceanswer_tips")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-niceanswer_pitfalls")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-niceanswer_links")
// ACCOMPLISHMENT: Nice Answer on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-niceanswer_help")
