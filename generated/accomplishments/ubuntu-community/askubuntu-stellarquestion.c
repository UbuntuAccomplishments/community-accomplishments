[accomplishment]
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
// Stellar Question on Ask Ubuntu

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// A short description of the accomplishment.
//          NOTE: Describe this in the past tense as if it has been achieved (e.g. Registered On Launchpad). 
_("ubuntu-community/askubuntu-stellarquestion_title")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-stellarquestion_description")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-stellarquestion_summary")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-stellarquestion_steps")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-stellarquestion_tips")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-stellarquestion_pitfalls")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-stellarquestion_links")
// ACCOMPLISHMENT: Stellar Question on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-stellarquestion_help")
