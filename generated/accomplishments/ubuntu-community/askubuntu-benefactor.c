[accomplishment]
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('t' field)
// .
...
_("ubuntu-community/askubuntu-benefactor_title")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('d' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-benefactor_description")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-benefactor_summary")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-benefactor_steps")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('t' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-benefactor_tips")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('p' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-benefactor_pitfalls")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/askubuntu-benefactor_links")
// ACCOMPLISHMENT: Benefactor on Ask Ubuntu ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/askubuntu-benefactor_help")
