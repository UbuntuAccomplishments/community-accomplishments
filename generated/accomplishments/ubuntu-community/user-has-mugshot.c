[accomplishment]
// ACCOMPLISHMENT: Setting a Mugshot in Launchpad Profile ('t' field)
// .
...
_("ubuntu-community/user-has-mugshot_title")
// ACCOMPLISHMENT: Setting a Mugshot in Launchpad Profile ('d' field)
// .
// ORIGINAL TRANSLATION:
// User has set a mugshot in their own Launchpad profile

// .
// ----- TRANSLATION INSTRUCTIONS ----- 
// Add a descriptive single-line summary of the accomplishment.
_("ubuntu-community/user-has-mugshot_description")
// ACCOMPLISHMENT: Setting a Mugshot in Launchpad Profile ('s' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/user-has-mugshot_summary")
// ACCOMPLISHMENT: Setting a Mugshot in Launchpad Profile ('s' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/user-has-mugshot_steps")
// ACCOMPLISHMENT: Setting a Mugshot in Launchpad Profile ('l' field)
// .
// ORIGINAL TRANSLATION:
...
_("ubuntu-community/user-has-mugshot_links")
// ACCOMPLISHMENT: Setting a Mugshot in Launchpad Profile ('h' field)
// .
// ORIGINAL TRANSLATION:
...
//          FORMATTING ALLOWED: <i> <strong> <tt>
_("ubuntu-community/user-has-mugshot_help")
